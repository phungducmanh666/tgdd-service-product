package services.product.api.productStatus.controller;
...
import services.product.api.productStatus.service.ProductStatusService;
...
public class ProductStatusController {
        ...
        public ResponseEntity<ApiSuccessResponse<?>> insert(
                ...
                return ResponseEntity.status(201).body(
                                ApiSuccessResponse.Created(
                                                productStatusService.insert(dto.getName())));
        }
        ...
        public ResponseEntity<ApiSuccessResponse<?>> findByUid(
                ...
                return ResponseEntity.status(200).body(
                                ApiSuccessResponse.Success(
                                                productStatusService.findByUid(uid)));
        }
        ...
        public ResponseEntity<ApiSuccessResponse<?>> findAll(
                ...
                return ResponseEntity.ok()
                                .body(ApiSuccessResponse.<FindAllResult<ProductStatusDto>>Success("",
                                                productStatusService.findAll(
                                                                currentPage,
                                                                itemsPerPage,
                                                                orderField,
                                                                orderDirection)));
        ...
        public ResponseEntity<ApiSuccessResponse<?>> update(
                ...
                return ResponseEntity.status(200)
                                .body(ApiSuccessResponse.Success(
                                                productStatusService.updateName(uid, dto.getName())));
        }

        @PatchMapping("/{uid}/setDefault")
        public ResponseEntity<ApiSuccessResponse<?>> setDefault(
                        @PathVariable(name = "uid") UUID uid) {

                return ResponseEntity.status(200)
                                .body(ApiSuccessResponse.Success(
                                                productStatusService.setDefault(uid)));
        }
        ...
        public ResponseEntity<ApiSuccessResponse<?>> deleteByUid(
                ...
                return ResponseEntity.ok().body(
                                ApiSuccessResponse.Success(productStatusService.deleteByUid(uid)));
        }
        ...
        public ResponseEntity<ApiSuccessResponse<?>> nameExists(
                ...
                return ResponseEntity.ok().body(
                                ApiSuccessResponse.Success(productStatusService.nameExists(name)));
        }
}
