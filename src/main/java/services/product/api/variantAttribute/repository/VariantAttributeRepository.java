package services.product.api.variantAttribute.repository;
...
public class VariantAttributeRepository {
    ...
    public VariantAttributeRepository(JdbcTemplate jdbcTemplate) {
    ...
    public VariantAttributeDto insert(String name) {
        VariantAttributeDto item = VariantAttributeDto.builder()
    ...
    public VariantAttributeDto findByUId(UUID uid) {
        ...
        try {
            VariantAttributeDto item = jdbcTemplate.queryForObject(sql, new VariantAttributeRowMapper(),
                    uid.toString());
            return item;
    ...
    public FindAllResult<VariantAttributeDto> findAll(int page, int size, String orderField,
        ...
        List<VariantAttributeDto> data = jdbcTemplate.query(dataSql, new VariantAttributeRowMapper());
        ...
        return FindAllResult.<VariantAttributeDto>builder()
                .data(data)
